...
data class DetailUiState(
    ...
    val versionDownloadUris: Map<Int, Uri?> = emptyMap(),
    // 分页
    val page: Int = 1,
...
sealed class DetailUiAction {
    ...
    data class DownloadCompleted(val downloadUri: Uri?) : DetailUiAction()
    ...
    data class VersionDownloadCompleted(val index: Int, val downloadUri: Uri?) : DetailUiAction()
...
interface DetailUiEffect {
    ...
    // 新增：安装
    data class Install(val downloadUri: Uri) : DetailUiEffect
    // 新增：版本下载
